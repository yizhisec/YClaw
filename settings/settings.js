// ============================================
// AivoClaw Settings — 双栏设置交互逻辑
// ============================================

(function () {
  "use strict";

  // iframe 嵌入主窗口时，优先复用父窗口暴露的 aivoclaw bridge
  try {
    if (!window.aivoclaw && window.parent && window.parent !== window && window.parent.aivoclaw) {
      window.aivoclaw = window.parent.aivoclaw;
    }
  } catch {
    // 跨域场景忽略，继续走本窗口 aivoclaw
  }
  ...
  const PROVIDERS = {
    anthropic: {
      placeholder: "sk-ant-...",
      platformUrl: "https://console.anthropic.com?utm_source=aivoclaw",
      models: [
        "claude-sonnet-4-6",
        "claude-opus-4-6",
    ...
    openai: {
      placeholder: "sk-...",
      platformUrl: "https://platform.openai.com?utm_source=aivoclaw",
      models: ["gpt-5.4", "gpt-5.2", "gpt-5.2-codex"],
    },
    google: {
      placeholder: "AI...",
      platformUrl: "https://aistudio.google.com?utm_source=aivoclaw",
  ...
  const SUB_PLATFORM_URLS = {
    "moonshot-cn": "https://platform.moonshot.cn?utm_source=aivoclaw",
    "moonshot-ai": "https://platform.moonshot.ai?utm_source=aivoclaw",
    "kimi-code": "https://kimi.com/code?utm_source=aivoclaw",
  };
  ...
  const I18N = {
    en: {
      ...
      "wecom.desc": "Connect WeCom so users can talk to YClaw directly in WeCom.",
      ...
      "wecom.dmHint": "Pairing is recommended for direct messages. When set to open, YClaw will automatically write allowFrom=[\"*\"].",
      "wecom.docs": "Plugin README →",
      "wecom.getKey": "Open WeCom Admin →",
      "wecom.save": "Save",
      "wecom.saving": "Saving…",
      "dingtalk.desc": "Connect DingTalk so users can talk to YClaw directly in DingTalk.",
      ...
      "dingtalk.gatewayHint": "YClaw will auto-use the current gateway token and enable the required chatCompletions HTTP endpoint.",
      "dingtalk.docs": "Setup Guide →",
      "dingtalk.getKey": "Open DingTalk Open Platform →",
      "dingtalk.save": "Save",
      "dingtalk.saving": "Saving…",
      "qq.desc": "Connect QQ Bot so users can talk to YClaw directly in QQ.",
      "qq.enabled": "Enable",
      ...
      "error.wecomNotBundled": "WeCom plugin is missing. Please reinstall YClaw.",
      ...
      "error.dingtalkNotBundled": "DingTalk connector is missing. Please reinstall YClaw.",
      "error.noQqAppId": "Please enter the QQ Bot App ID.",
      "error.noQqClientSecret": "Please enter the QQ Bot Client Secret.",
      "error.qqNotBundled": "QQ Bot component is missing. Please reinstall YClaw.",
      ...
      "kimi.title": "KimiClaw",
      "kimi.desc": "Control YClaw remotely via Kimi",
      "kimi.enabled": "Enable",
      ...
      "advanced.cliUninstallConfirm": "Uninstall the YClaw terminal command now?",
      ...
      "about.aivoClawVersion": "YClaw Version",
    ...
    zh: {
      ...
      "nav.feishu": "飞书集成",
      "chat.title": "聊天集成",
      "chat.desc": "连接飞书、企业微信、钉钉、Kimi 或 QQ，让用户直接在聊天软件里和 YClaw 对话。",
      ...
      "feishu.kindUser": "用户",
      "feishu.kindGroup": "群聊",
      "wecom.desc": "连接企业微信机器人，让用户直接在企业微信里和 YClaw 对话。",
      "wecom.enabled": "启用状态",
      "wecom.botId": "Bot ID",
      "wecom.secret": "Secret",
      ...
      “wecom.dmHint”: “私聊建议优先使用”先配对再访问”；切到”所有人可直接访问”时，YClaw 会自动写入 allowFrom=[\”*\”]。”,
      "wecom.docs": "插件说明 →",
      "wecom.getKey": "打开企业微信后台 →",
      "wecom.save": "保存",
      "wecom.saving": "保存中…",
      "dingtalk.desc": "连接钉钉，让用户直接在钉钉里和 YClaw 对话。",
      "dingtalk.enabled": "启用状态",
      "dingtalk.clientId": "Client ID / AppKey",
      "dingtalk.clientSecret": "Client Secret / AppSecret",
      "dingtalk.sessionTimeout": "会话超时（毫秒）",
      "dingtalk.sessionTimeoutHint": "默认 1800000 毫秒（30 分钟）。",
      "dingtalk.gatewayHint": "YClaw 会自动复用当前 Gateway token，并补齐所需的 chatCompletions HTTP 端点。",
      "dingtalk.docs": "配置指南 →",
      "dingtalk.getKey": "打开钉钉开放平台 →",
      "dingtalk.save": "保存",
      "dingtalk.saving": "保存中…",
      "qq.desc": "连接 QQ Bot，让用户直接在 QQ 中和 YClaw 对话。",
      "qq.enabled": "启用状态",
      "qq.appId": "QQ Bot App ID",
      "qq.clientSecret": "Client Secret",
      ...
      "error.wecomNotBundled": "企业微信插件组件缺失，请重新安装 YClaw。",
      ...
      "error.dingtalkNotBundled": "钉钉连接器组件缺失，请重新安装 YClaw。",
      "error.noQqAppId": "请输入 QQ Bot App ID。",
      "error.noQqClientSecret": "请输入 QQ Bot Client Secret。",
      "error.qqNotBundled": "QQ Bot 组件缺失，请重新安装 YClaw。",
      ...
      "advanced.cliUninstallConfirm": "确认要卸载 YClaw 终端命令吗？",
      "advanced.clawHubRegistry": "ClawHub Registry",
      "advanced.clawHubRegistryPlaceholder": "https://clawhub.ai",
      "advanced.save": "保存",
      "advanced.saving": "保存中…",
      ...
      "about.aivoClawVersion": "YClaw 版本",
  ...
  async function handleSave() {
    ...
    try {
      // 先验证
      var verifyResult = await window.aivoclaw.settingsVerifyKey(params);
      ...
      // 再保存
      var saveResult = await window.aivoclaw.settingsSaveProvider(buildSavePayload(params));
      ...
      try {
        var refreshResult = await window.aivoclaw.settingsGetConfig();
  ...
  async function loadChPairingRequests(options) {
    ...
    try {
      var result = getCurrentAccessPlatform() === "wecom"
        ? await window.aivoclaw.settingsListWecomPairing()
        : await window.aivoclaw.settingsListFeishuPairing();
      if (!result.success) {
  ...
  async function loadChApprovedEntries(options) {
    ...
    try {
      var result = getCurrentAccessPlatform() === "wecom"
        ? await window.aivoclaw.settingsListWecomApproved()
        : await window.aivoclaw.settingsListFeishuApproved();
      if (!result.success) {
  ...
  async function handleChPairingApprove(code, id, name) {
    ...
    try {
      var result = getCurrentAccessPlatform() === "wecom"
        ? await window.aivoclaw.settingsApproveWecomPairing({
            code: trimmed,
            id: String(id || "").trim(),
            name: String(name || "").trim(),
          })
        : await window.aivoclaw.settingsApproveFeishuPairing({
        code: trimmed,
        id: String(id || "").trim(),
        name: String(name || "").trim(),
      });
  ...
  async function handleChPairingReject(code, id, name) {
    ...
    try {
      var result = getCurrentAccessPlatform() === "wecom"
        ? await window.aivoclaw.settingsRejectWecomPairing({
            code: trimmed,
            id: String(id || "").trim(),
            name: String(name || "").trim(),
          })
        : await window.aivoclaw.settingsRejectFeishuPairing({
        code: trimmed,
        id: String(id || "").trim(),
        name: String(name || "").trim(),
      });
  ...
  async function handleChApprovedRemove(kind, id) {
    ...
    try {
      var result = getCurrentAccessPlatform() === "wecom"
        ? await window.aivoclaw.settingsRemoveWecomApproved({
            kind: entryKind,
            id: entryId,
          })
        : await window.aivoclaw.settingsRemoveFeishuApproved({
        kind: entryKind,
        id: entryId,
      });
      if (!result.success) {
  ...
  async function handleChGroupDialogConfirm() {
    ...
    hideChMsg();
    try {
      var result = await window.aivoclaw.settingsAddFeishuGroupAllowFrom({ id: groupId });
      if (!result.success) {
  ...
  async function handleChSave() {
    ...
    if (!enabled) {
      ...
      hideChMsg();
      try {
        var result = await window.aivoclaw.settingsSaveChannel({ enabled: false });
        setChSaving(false);
        if (result.success) {
          showToast(t("common.saved"));
          refreshChPairingPanels({ silent: true });
    ...
    try {
      var verifyResult = await window.aivoclaw.settingsVerifyKey({
        provider: "feishu",
        appId: appId,
        appSecret: appSecret,
      });
      ...
      var saveResult = await window.aivoclaw.settingsSaveChannel({
        appId: appId,
        appSecret: appSecret,
        enabled: true,
  ...
  async function loadChannelConfig() {
    try {
      var result = await window.aivoclaw.settingsGetChannelConfig();
  ...
  async function handleWecomSave() {
    ...
    if (!enabled) {
      ...
      hideWecomMsg();
      try {
        var disableResult = await window.aivoclaw.settingsSaveWecomConfig({ enabled: false });
    ...
    try {
      var saveResult = await window.aivoclaw.settingsSaveWecomConfig({
        enabled: true,
        botId: botId,
        secret: secret,
  ...
  async function loadWecomConfig() {
    try {
      var result = await window.aivoclaw.settingsGetWecomConfig();
      if (!result.success || !result.data) return;
  ...
  async function handleDingtalkSave() {
    ...
    if (!enabled) {
      ...
      hideDingtalkMsg();
      try {
        var disableResult = await window.aivoclaw.settingsSaveDingtalkConfig({ enabled: false });
    ...
    try {
      ...
      var saveResult = await window.aivoclaw.settingsSaveDingtalkConfig({
        enabled: true,
        clientId: clientId,
        clientSecret: clientSecret,
  ...
  async function loadDingtalkConfig() {
    try {
      var result = await window.aivoclaw.settingsGetDingtalkConfig();
      if (!result.success || !result.data) return;
  ...
  async function handleQqSave() {
    ...
    if (!enabled) {
      ...
      hideQqMsg();
      try {
        var disableResult = await window.aivoclaw.settingsSaveQqbotConfig({ enabled: false });
        setQqSaving(false);
        if (disableResult.success) {
          showToast(t("common.saved"));
        } else {
    ...
    try {
      ...
      var saveResult = await window.aivoclaw.settingsSaveQqbotConfig({
        enabled: true,
        appId: appId,
        clientSecret: clientSecret,
  ...
  async function loadQqbotConfig() {
    try {
      var result = await window.aivoclaw.settingsGetQqbotConfig();
      if (!result.success || !result.data) return;
  ...
  async function loadAdvancedConfig() {
    try {
      var result = await window.aivoclaw.settingsGetAdvanced();
  ...
  async function loadCliStatus() {
    if (
      !window.aivoclaw ||
      typeof window.aivoclaw.settingsGetCliStatus !== "function" ||
      typeof window.aivoclaw.settingsInstallCli !== "function" ||
      typeof window.aivoclaw.settingsUninstallCli !== "function"
    ) {
    ...
    try {
      var result = await window.aivoclaw.settingsGetCliStatus();
  ...
  async function handleCliToggle() {
    ...
    try {
      var result = wantInstall
        ? await window.aivoclaw.settingsInstallCli()
        : await window.aivoclaw.settingsUninstallCli();
  ...
  async function handleAdvSave() {
    ...
    try {
      var result = await window.aivoclaw.settingsSaveAdvanced({
  ...
  function requestEmbeddedAppearanceInit() {
    ...
    window.parent.postMessage(
      {
        source: "aivoclaw-settings-embed",
  ...
  function handleAppearanceInitMessage(event) {
    ...
    if (!data || data.source !== "aivoclaw-chat-ui" || data.type !== "appearance-init") {
      return;
    }
  ...
  async function loadKimiConfig() {
    try {
      var result = await window.aivoclaw.settingsGetKimiConfig();
      if (!result.success || !result.data) return;
  ...
  async function handleKimiSave() {
    ...
    if (!enabled) {
      ...
      hideKimiMsg();
      try {
        var result = await window.aivoclaw.settingsSaveKimiConfig({ enabled: false });
        setKimiSaving(false);
        if (result.success) {
          showToast(t("common.saved"));
        } else {
    ...
    try {
      var result = await window.aivoclaw.settingsSaveKimiConfig({ botToken: botToken, enabled: true });
      if (!result.success) {
        showKimiMsg(result.message || "Save failed", "error");
        setKimiSaving(false);
        return;
  ...
  async function loadSearchConfig() {
    try {
      var result = await window.aivoclaw.settingsGetKimiSearchConfig();
      if (!result.success || !result.data) return;
  ...
  async function handleSearchSave() {
    ...
    try {
      ...
      var result = await window.aivoclaw.settingsSaveKimiSearchConfig(params);
  ...
  async function loadCurrentConfig() {
    try {
      var result = await window.aivoclaw.settingsGetConfig();
      if (!result.success || !result.data) return;
  ...
  async function loadBackupData() {
    if (!window.aivoclaw || !window.aivoclaw.settingsListConfigBackups) return;

    try {
      var result = await window.aivoclaw.settingsListConfigBackups();
      if (!result.success || !result.data) {
  ...
  async function handleRestoreBackup(fileName) {
    ...
    try {
      var result = await window.aivoclaw.settingsRestoreConfigBackup({ fileName: fileName });
      if (!result.success) {
      ...
      if (window.aivoclaw && window.aivoclaw.restartGateway) {
  ...
  async function handleRestoreLastKnownGood() {
    ...
    try {
      var result = await window.aivoclaw.settingsRestoreLastKnownGood();
      if (!result.success) {
        showBackupMsg(result.message || "Restore failed", "error");
        setBackupRestoring(false);
        return;
  ...
  async function refreshGatewayState() {
    if (!window.aivoclaw || !window.aivoclaw.getGatewayState) {
      setGatewayStateUI("unknown");
      return;
    }
    try {
      var state = await window.aivoclaw.getGatewayState();
  ...
  async function handleGatewayAction(kind) {
    ...
    try {
      if (kind === "restart" && window.aivoclaw.restartGateway) {
        window.aivoclaw.restartGateway();
      } else if (kind === "start" && window.aivoclaw.startGateway) {
        window.aivoclaw.startGateway();
      } else if (kind === "stop" && window.aivoclaw.stopGateway) {
        window.aivoclaw.stopGateway();
      } else {
  ...
  async function handleResetConfig() {
    ...
    if (!window.aivoclaw || !window.aivoclaw.settingsResetConfigAndRelaunch) return;

    setBackupResetting(true);
    hideBackupMsg();

    try {
      var result = await window.aivoclaw.settingsResetConfigAndRelaunch();
      if (!result.success) {
  ...
  function bindEvents() {
    ...
    els.platformLink.addEventListener("click", function (e) {
      ...
      if (url && window.aivoclaw && window.aivoclaw.openExternal) {
        window.aivoclaw.openExternal(url);
      }
    });
    ...
    els.chDocsLink.addEventListener("click", function (e) {
      e.preventDefault();
      if (window.aivoclaw && window.aivoclaw.openExternal) {
        window.aivoclaw.openExternal("https://aivoclaw.cn/docs/tutorials/feishu-bot.html");
      }
    });
    els.chConsoleLink.addEventListener("click", function (e) {
      e.preventDefault();
      if (window.aivoclaw && window.aivoclaw.openExternal) {
        window.aivoclaw.openExternal("https://open.feishu.cn/app");
      }
    });
    ...
    if (els.wecomDocsLink) {
      els.wecomDocsLink.addEventListener("click", function (e) {
        e.preventDefault();
        if (window.aivoclaw && window.aivoclaw.openExternal) {
          window.aivoclaw.openExternal("https://github.com/WecomTeam/wecom-openclaw-plugin");
        }
      });
    }
    if (els.wecomConsoleLink) {
      els.wecomConsoleLink.addEventListener("click", function (e) {
        e.preventDefault();
        if (window.aivoclaw && window.aivoclaw.openExternal) {
          window.aivoclaw.openExternal("https://work.weixin.qq.com/");
        }
      });
    }
    if (els.btnWecomSave) {
    ...
    if (els.dingtalkDocsLink) {
      els.dingtalkDocsLink.addEventListener("click", function (e) {
        e.preventDefault();
        if (window.aivoclaw && window.aivoclaw.openExternal) {
          window.aivoclaw.openExternal("https://github.com/DingTalk-Real-AI/dingtalk-openclaw-connector");
        }
      });
    }
    if (els.dingtalkConsoleLink) {
      els.dingtalkConsoleLink.addEventListener("click", function (e) {
        e.preventDefault();
        if (window.aivoclaw && window.aivoclaw.openExternal) {
          window.aivoclaw.openExternal("https://open.dingtalk.com/");
        }
      });
    }
    ...
    if (els.qqConsoleLink) {
      els.qqConsoleLink.addEventListener("click", function (e) {
        e.preventDefault();
        if (window.aivoclaw && window.aivoclaw.openExternal) {
          window.aivoclaw.openExternal("https://q.qq.com/qqbot/openclaw/");
        }
      });
    }
    if (els.btnQqSave) {
    ...
    els.kimiBotPageLink.addEventListener("click", function (e) {
      e.preventDefault();
      if (window.aivoclaw && window.aivoclaw.openExternal) {
        window.aivoclaw.openExternal("https://www.kimi.com/bot?utm_source=aivoclaw");
      }
    });
    ...
    if (els.searchPlatformLink) {
      els.searchPlatformLink.addEventListener("click", function (e) {
        e.preventDefault();
        if (window.aivoclaw && window.aivoclaw.openExternal) {
          window.aivoclaw.openExternal("https://kimi.com/code?utm_source=aivoclaw");
        }
      });
    }
    ...
    if (window.aivoclaw && window.aivoclaw.onSettingsNavigate) {
      window.aivoclaw.onSettingsNavigate(function (payload) {
        if (!payload || !payload.tab) return;
        switchTab(payload.tab);
        applyRecoveryNotice(payload.notice || "");
      });
    }
    if (window.aivoclaw && window.aivoclaw.onPairingState) {
      window.aivoclaw.onPairingState(function (payload) {
        if (!isCurrentAccessEnabled() || !isCurrentAccessPairingMode()) {
          return;
        }
    ...
    // 订阅更新状态推送
    if (window.aivoclaw && window.aivoclaw.onUpdateState) {
      window.aivoclaw.onUpdateState(function (state) {
  ...
  async function loadAboutInfo() {
    try {
      var info = await window.aivoclaw.settingsGetAboutInfo();
      document.getElementById("aboutAivoClawVersion").textContent = info.aivoClawVersion;
      document.getElementById("aboutOpenClawVersion").textContent = info.openClawVersion;
    } catch (e) {
      console.error("Failed to load about info:", e);
    }
    try {
      var state = await window.aivoclaw.getUpdateState();
      renderUpdateStatus(state);
    } catch (e) {}
  }
  ...
  function renderUpdateStatus(state) {
    ...
    switch (state.status) {
      ...
      case "available":
        ...
        btnEl.disabled = false;
        btnEl.onclick = function () { window.aivoclaw.downloadAndInstallUpdate(); };
        break;
      case "downloading":
        statusEl.classList.remove("hidden");
  ...
  function init() {
    ...
    // 嵌入模式隐藏导航
    var params = new URLSearchParams(window.location.search);
    if (params.get("hideNav") === "1") {
      document.body.classList.add("embed-no-nav");
    }

    // 监听父窗口 postMessage 切换 tab
    window.addEventListener("message", function (event) {
      var data = event.data;
      if (!data || data.source !== "aivoclaw-chat-ui") return;
      if (data.type === "switch-tab" && data.payload && data.payload.tab) {
        switchTab(data.payload.tab);
      }
    });
