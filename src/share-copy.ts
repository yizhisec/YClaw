...
const FALLBACK_SHARE_COPY_PAYLOAD: ShareCopyPayload = {
  ...
  locales: {
    zh: {
      ...
      body: [
        "我最近在用 YClaw，很快就安装好了 OpenClaw。",
        "",
        "YClaw 是 OpenClaw 的一键安装包，几分钟就能装好并开始用。",
        "",
        "他们说 OpenClaw 可以做这些事：",
    ...
    en: {
      title: "Share YClaw with friends",
      subtitle:
        "Copy this text and share it with your friends or group chats. The creator will really appreciate it 😘",
      body: [
        "I've been using YClaw lately, and it seriously boosts execution speed.",
        "",
        "YClaw is a one-click installer for OpenClaw, so you can get started in minutes.",
        "",
