/**
 * Minimal i18n module for AivoClaw Chat UI.
...
const dict: Record<Locale, Record<string, string>> = {
  zh: {
    // App
    "app.windowTitle": "YClaw 一键安装OpenClaw",
    ...
    // AivoClaw settings page
    "settings.title": "设置",
    "settings.subtitle": "管理外观显示与聊天展示偏好",
    "settings.backToChat": "返回对话",

    // 工具调用详情
    "settings.showToolDetails": "显示工具调用详情",
    "settings.showToolDetailsDesc": "开启后在对话中显示工具调用过程和结果",
    ...
    // Share prompt
    "sharePrompt.title": "分享 YClaw 给朋友",
    ...
    // 左侧边栏 tab
    "leftSidebar.imTab": "IM通道",
    "leftSidebar.scheduleTab": "定时任务",
    "leftSidebar.addChannel": "添加通道",
    "leftSidebar.addSchedule": "添加定时任务",
    "leftSidebar.noChannels": "暂无已配置的通道",
    "leftSidebar.connected": "已连接",
    "leftSidebar.disconnected": "未连接",
    "leftSidebar.noSchedule": "暂无定时任务",
    "leftSidebar.running": "运行中",
    "leftSidebar.paused": "已暂停",

    // 右侧边栏
    "rightSidebar.noArtifacts": "暂无产出物",
    "rightSidebar.noActivity": "暂无活动记录",

    // 聊天头部
    "chatHeader.artifacts": "产出物",
    "chatHeader.activity": "活动记录",
  ...
  en: {
    // App
    "app.windowTitle": "YClaw - One-click installer for OpenClaw",
    ...
    // Tool details
    "settings.showToolDetails": "Show tool call details",
    "settings.showToolDetailsDesc": "Show tool call process and results in conversations",
    ...
    // Share prompt
    "sharePrompt.title": "Share YClaw with friends",
    ...
    // Left sidebar tabs
    "leftSidebar.imTab": "IM Channels",
    "leftSidebar.scheduleTab": "Schedule",
    "leftSidebar.addChannel": "Add channel",
    "leftSidebar.addSchedule": "Add scheduled task",
    "leftSidebar.noChannels": "No channels configured",
    "leftSidebar.connected": "Connected",
    "leftSidebar.disconnected": "Disconnected",
    "leftSidebar.noSchedule": "No scheduled tasks",
    "leftSidebar.running": "Running",
    "leftSidebar.paused": "Paused",

    // Right sidebar
    "rightSidebar.noArtifacts": "No artifacts yet",
    "rightSidebar.noActivity": "No activity yet",

    // Chat header
    "chatHeader.artifacts": "Artifacts",
    "chatHeader.activity": "Activity",
